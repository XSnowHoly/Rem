...
class ImageTool{
	...
	*/
	public static function water($dst,$water,$save=NULL,$pos=2,$alpha=50){
		...
		switch ($pos) {
			...
			case 1: // 右上角
				$posx = $dinfo['width'] - $winfo['windth'];
				$posy = 0;
				break;

			case 3: // 左下角
				$posx = 0;
				$posy = $dinfo['height'] - $winfo['wheight'];
				break;
	...
	*/
	...
	//写验证码
        public static function captcha($width=80,$height=35) {
                //造画布
